...
KodiPVRDetailsBroadcast _$KodiPVRDetailsBroadcastFromJson(
  ...
  return _KodiPVRDetailsBroadcast.fromJson(json);
}

/// @nodoc
mixin _$KodiPVRDetailsBroadcast {
  ...
  int get parentalRating => throw _privateConstructorUsedError;
  ...
  bool get wasActive => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $KodiPVRDetailsBroadcastCopyWith<$Res> {
  factory $KodiPVRDetailsBroadcastCopyWith(KodiPVRDetailsBroadcast value,
          $Res Function(KodiPVRDetailsBroadcast) then) =
      _$KodiPVRDetailsBroadcastCopyWithImpl<$Res, KodiPVRDetailsBroadcast>;
  @useResult
  $Res call(
      ...
      int progress,
      @JsonKey(name: 'progresspercentage') double progressPercentage,
      int rating,
      String recording,
      int runtime,
...
/// @nodoc
class _$KodiPVRDetailsBroadcastCopyWithImpl<$Res,
        $Val extends KodiPVRDetailsBroadcast>
    implements $KodiPVRDetailsBroadcastCopyWith<$Res> {
  _$KodiPVRDetailsBroadcastCopyWithImpl(this._value, this._then);
    ...
    return _then(_value.copyWith(
      ...
      hasTimer: null == hasTimer
          ...
          : hasTimer // ignore: cast_nullable_to_non_nullable
              as bool,
      hasTimerRule: null == hasTimerRule
          ? _value.hasTimerRule
          : hasTimerRule // ignore: cast_nullable_to_non_nullable
              as bool,
      ...
      originalTitle: null == originalTitle
          ...
          : originalTitle // ignore: cast_nullable_to_non_nullable
              as String,
      parentalRating: null == parentalRating
          ? _value.parentalRating
          : parentalRating // ignore: cast_nullable_to_non_nullable
              as int,
      plot: null == plot
          ? _value.plot
      ...
      title: null == title
          ...
          : title // ignore: cast_nullable_to_non_nullable
              as String,
      wasActive: null == wasActive
          ? _value.wasActive
          : wasActive // ignore: cast_nullable_to_non_nullable
              as bool,
      writer: null == writer
          ? _value.writer
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.episodePart, episodePart) ||
            ...
            (identical(other.hasTimerRule, hasTimerRule) ||
                other.hasTimerRule == hasTimerRule) &&
            ...
            (identical(other.parentalRating, parentalRating) ||
            ...
            (identical(other.wasActive, wasActive) ||
