...
mixin _$KodiListItemAll {
  ...
  List<int>? get albumartistid => throw _privateConstructorUsedError;
  ...
  String? get disctTtle => throw _privateConstructorUsedError;
...
/// @nodoc
abstract class $KodiListItemAllCopyWith<$Res> {
  factory $KodiListItemAllCopyWith(
          KodiListItemAll value, $Res Function(KodiListItemAll) then) =
      _$KodiListItemAllCopyWithImpl<$Res, KodiListItemAll>;
  @useResult
  $Res call(
      {String? channel,
...
/// @nodoc
class _$KodiListItemAllCopyWithImpl<$Res, $Val extends KodiListItemAll>
    implements $KodiListItemAllCopyWith<$Res> {
  _$KodiListItemAllCopyWithImpl(this._value, this._then);
  ...
  $Res call({
    ...
    Object? subChannelNumber = freezed,
    ...
    return _then(_value.copyWith(
      ...
      startTime: freezed == startTime
          ...
          : startTime // ignore: cast_nullable_to_non_nullable
              as String?,
      subChannelNumber: freezed == subChannelNumber
      ...
      disc: freezed == disc
          ...
          : disc // ignore: cast_nullable_to_non_nullable
              as int?,
      disctTtle: freezed == disctTtle
          ? _value.disctTtle
          : disctTtle // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$KodiListItemAllImpl implements _KodiListItemAll {
  const _$KodiListItemAllImpl(
      ...
      @JsonKey(name: 'subchannelnumber') this.subChannelNumber,
      this.album,
      ...
      this.description,
      this.disc,
      @JsonKey(name: 'disctitle') this.disctTtle,
  ...
  final List<int>? _albumartistid;
  @override
  @JsonKey(name: 'albumartistid')
  List<int>? get albumartistid {
    final value = _albumartistid;
    if (value == null) return null;
    if (_albumartistid is EqualUnmodifiableListView) return _albumartistid;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @JsonKey(name: 'setid')
  final int? setId;
  final List<String>? _showLink;
  @override
  @JsonKey(name: 'showlink')
  List<String>? get showLink {
    final value = _showLink;
    if (value == null) return null;
    if (_showLink is EqualUnmodifiableListView) return _showLink;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  @override
  String toString() {
    return 'KodiListItemAll(channel: $channel, channelNumber: $channelNumber, channelType: $channelType, endTime: $endTime, hidden: $hidden, locked: $locked, startTime: $startTime, subChannelNumber: $subChannelNumber, album: $album, albumArtist: $albumArtist, albumartistid: $albumartistid, albumId: $albumId, albumlabel: $albumlabel, albumReleaseType: $albumReleaseType, albumStatus: $albumStatus, bitrate: $bitrate, bpm: $bpm, cast: $cast, channels: $channels, comment: $comment, compilation: $compilation, contributors: $contributors, country: $country, customProperties: $customProperties, description: $description, disc: $disc, disctTtle: $disctTtle, displayComposer: $displayComposer, displayConductor: $displayConductor, displayLyricist: $displayLyricist, displayOrchestra: $displayOrchestra, duration: $duration, dynpath: $dynpath, episode: $episode, episodeGuide: $episodeGuide, firstAired: $firstAired, id: $id, imdbNumber: $imdbNumber, isBoxSet: $isBoxSet, lyrics: $lyrics, mediaPath: $mediaPath, mood: $mood, mpaa: $mpaa, musicBrainzArtistId: $musicBrainzArtistId, musicBrainzTrackId: $musicBrainzTrackId, originalDate: $originalDate, originalTitle: $originalTitle, plotOutline: $plotOutline, premiered: $premiered, productionCode: $productionCode, releaseDate: $releaseDate, sampleRate: $sampleRate, season: $season, set: $set, setId: $setId, showLink: $showLink, showTitle: $showTitle, sortTitle: $sortTitle, specialSortEpisode: $specialSortEpisode, specialSortSeason: $specialSortSeason, studio: $studio, style: $style, tag: $tag, tagline: $tagline, theme: $theme, top250: $top250, totalDiscs: $totalDiscs, track: $track, trailer: $trailer, tvShowId: $tvShowId, type: $type, uniqueId: $uniqueId, votes: $votes, watchedEpisodes: $watchedEpisodes, writer: $writer, director: $director, resume: $resume, runtime: $runtime, streamDetails: $streamDetails, dateAdded: $dateAdded, file: $file, lastPlayed: $lastPlayed, plot: $plot, title: $title, art: $art, playCount: $playCount, fanart: $fanart, thumbnail: $thumbnail, label: $label, artist: $artist, artistId: $artistId, displayArtist: $displayArtist, musicBrainzAlbumArtistId: $musicBrainzAlbumArtistId, rating: $rating, sortArtist: $sortArtist, userRating: $userRating, year: $year, genre: $genre)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._albumartistid, _albumartistid) &&
            (identical(other.albumId, albumId) || other.albumId == albumId) &&
            (identical(other.albumlabel, albumlabel) ||
                other.albumlabel == albumlabel) &&
            (identical(other.albumReleaseType, albumReleaseType) ||
                other.albumReleaseType == albumReleaseType) &&
            (identical(other.albumStatus, albumStatus) ||
            ...
            (identical(other.disctTtle, disctTtle) ||
                other.disctTtle == disctTtle) &&
            (identical(other.displayComposer, displayComposer) ||
                other.displayComposer == displayComposer) &&
            (identical(other.displayConductor, displayConductor) ||
                other.displayConductor == displayConductor) &&
            (identical(other.displayLyricist, displayLyricist) ||
                other.displayLyricist == displayLyricist) &&
            (identical(other.displayOrchestra, displayOrchestra) ||
                other.displayOrchestra == displayOrchestra) &&
            (identical(other.duration, duration) ||
                other.duration == duration) &&
            (identical(other.dynpath, dynpath) || other.dynpath == dynpath) &&
            ...
            const DeepCollectionEquality().equals(other._showLink, _showLink) &&
            (identical(other.showTitle, showTitle) ||
                other.showTitle == showTitle) &&
            (identical(other.sortTitle, sortTitle) ||
                other.sortTitle == sortTitle) &&
            (identical(other.specialSortEpisode, specialSortEpisode) ||
                other.specialSortEpisode == specialSortEpisode) &&
            (identical(other.specialSortSeason, specialSortSeason) ||
                other.specialSortSeason == specialSortSeason) &&
            ...
            (identical(other.playCount, playCount) || other.playCount == playCount) &&
            ...
            (identical(other.displayArtist, displayArtist) || other.displayArtist == displayArtist) &&
            const DeepCollectionEquality().equals(other._musicBrainzAlbumArtistId, _musicBrainzAlbumArtistId) &&
            (identical(other.rating, rating) || other.rating == rating) &&
            (identical(other.sortArtist, sortArtist) || other.sortArtist == sortArtist) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        const DeepCollectionEquality().hash(_albumartistid),
        albumId,
        albumlabel,
        albumReleaseType,
        albumStatus,
        ...
        set,
        setId,
        const DeepCollectionEquality().hash(_showLink),
        showTitle,
        sortTitle,
        specialSortEpisode,
        specialSortSeason,
...
abstract class _KodiListItemAll implements KodiListItemAll {
  const factory _KodiListItemAll(
      {final String? channel,
      ...
      final String? description,
      final int? disc,
      @JsonKey(name: 'disctitle') final String? disctTtle,
      ...
      @JsonKey(name: 'premiered') final String? premiered,
