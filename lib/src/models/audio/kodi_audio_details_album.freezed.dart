...
KodiAudioDetailsAlbum _$KodiAudioDetailsAlbumFromJson(
  ...
  return _KodiAudioDetailsAlbum.fromJson(json);
}
...
/// @nodoc
abstract class $KodiAudioDetailsAlbumCopyWith<$Res> {
  factory $KodiAudioDetailsAlbumCopyWith(KodiAudioDetailsAlbum value,
          $Res Function(KodiAudioDetailsAlbum) then) =
...
/// @nodoc
class _$KodiAudioDetailsAlbumCopyWithImpl<$Res,
        $Val extends KodiAudioDetailsAlbum>
    implements $KodiAudioDetailsAlbumCopyWith<$Res> {
  _$KodiAudioDetailsAlbumCopyWithImpl(this._value, this._then);
