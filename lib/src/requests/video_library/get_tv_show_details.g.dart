...
_$GetTVShowDetailsImpl _$$GetTVShowDetailsImplFromJson(
        Map<String, dynamic> json) =>
    _$GetTVShowDetailsImpl(
...
Map<String, dynamic> _$$GetTVShowDetailsImplToJson(
    _$GetTVShowDetailsImpl instance) {
