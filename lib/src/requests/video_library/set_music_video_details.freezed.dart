...
/// @nodoc
abstract class $SetMusicVideoDetailsCopyWith<$Res> {
  factory $SetMusicVideoDetailsCopyWith(SetMusicVideoDetails value,
          $Res Function(SetMusicVideoDetails) then) =
      _$SetMusicVideoDetailsCopyWithImpl<$Res, SetMusicVideoDetails>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SetMusicVideoDetailsCopyWithImpl<$Res,
        $Val extends SetMusicVideoDetails>
    implements $SetMusicVideoDetailsCopyWith<$Res> {
  _$SetMusicVideoDetailsCopyWithImpl(this._value, this._then);
...
class _$_SetMusicVideoDetails extends _SetMusicVideoDetails {
  ...
  @override
  String toString() {
    return 'SetMusicVideoDetails(id: $id, title: $title, playCount: $playCount, runtime: $runtime, directors: $directors, studios: $studios, year: $year, plot: $plot, album: $album, artists: $artists, genres: $genres, track: $track, lastPlayed: $lastPlayed, thumbnail: $thumbnail, fanart: $fanart, tags: $tags, art: $art, resume: $resume, rating: $rating, userRating: $userRating, dateAdded: $dateAdded, premiered: $premiered)';
  }
...
abstract class _SetMusicVideoDetails extends SetMusicVideoDetails {
  const factory _SetMusicVideoDetails(
