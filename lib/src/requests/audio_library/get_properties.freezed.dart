...
mixin _$GetProperties {
  Set<KodiAudioPropertyName> get properties =>
...
abstract class $GetPropertiesCopyWith<$Res> {
  ...
  @useResult
  $Res call({Set<KodiAudioPropertyName> properties});
}
...
class _$GetPropertiesImpl extends _GetProperties {
  const _$GetPropertiesImpl(final Set<KodiAudioPropertyName> properties)
  ...
  final Set<KodiAudioPropertyName> _properties;
  @override
  Set<KodiAudioPropertyName> get properties {
...
abstract class _GetProperties extends GetProperties {
  const factory _GetProperties(final Set<KodiAudioPropertyName> properties) =
      _$GetPropertiesImpl;
