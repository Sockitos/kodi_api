...
abstract class $GetSourcesCopyWith<$Res> {
  ...
  @useResult
  $Res call({KodiFilesMedia media, KodiListLimits? limits, KodiListSort? sort});
...
class _$_GetSources extends _GetSources {
  const _$_GetSources(this.media, {this.limits, this.sort}) : super._();
  ...
  @override
  String toString() {
    return 'GetSources(media: $media, limits: $limits, sort: $sort)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, media, limits, sort);
...
abstract class _GetSources extends GetSources {
  const factory _GetSources(final KodiFilesMedia media,
      {final KodiListLimits? limits, final KodiListSort? sort}) = _$_GetSources;
...
mixin _$GetSourcesResponse {
  List<KodiListItemsSources> get sources => throw _privateConstructorUsedError;
...
abstract class $GetSourcesResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {List<KodiListItemsSources> sources, KodiListLimitsReturned limits});
...
class _$_GetSourcesResponse implements _GetSourcesResponse {
  const _$_GetSourcesResponse(
      {required final List<KodiListItemsSources> sources, required this.limits})
      : _sources = sources;

  factory _$_GetSourcesResponse.fromJson(Map<String, dynamic> json) =>
      _$$_GetSourcesResponseFromJson(json);

  final List<KodiListItemsSources> _sources;
  @override
  List<KodiListItemsSources> get sources {
...
abstract class _GetSourcesResponse implements GetSourcesResponse {
  const factory _GetSourcesResponse(
      {required final List<KodiListItemsSources> sources,
