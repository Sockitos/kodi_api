...
mixin _$GetProperties {
  Set<KodiPVRPropertyName> get properties => throw _privateConstructorUsedError;
...
abstract class $GetPropertiesCopyWith<$Res> {
  ...
  @useResult
  $Res call({Set<KodiPVRPropertyName> properties});
}
...
class _$GetPropertiesImpl extends _GetProperties {
  const _$GetPropertiesImpl(final Set<KodiPVRPropertyName> properties)
  ...
  final Set<KodiPVRPropertyName> _properties;
  @override
  Set<KodiPVRPropertyName> get properties {
...
abstract class _GetProperties extends GetProperties {
  const factory _GetProperties(final Set<KodiPVRPropertyName> properties) =
      _$GetPropertiesImpl;
