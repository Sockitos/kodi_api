...
mixin _$GetProperties {
  Set<KodiGUIPropertyName> get properties => throw _privateConstructorUsedError;
...
abstract class $GetPropertiesCopyWith<$Res> {
  ...
  @useResult
  $Res call({Set<KodiGUIPropertyName> properties});
}
...
class _$GetPropertiesImpl extends _GetProperties {
  const _$GetPropertiesImpl(final Set<KodiGUIPropertyName> properties)
  ...
  final Set<KodiGUIPropertyName> _properties;
  @override
  Set<KodiGUIPropertyName> get properties {
...
abstract class _GetProperties extends GetProperties {
  const factory _GetProperties(final Set<KodiGUIPropertyName> properties) =
      _$GetPropertiesImpl;
